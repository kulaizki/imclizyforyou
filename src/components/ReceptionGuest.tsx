...
const ReceptionGuest = () => {
  return (
    <div className="flex flex-col md:flex-row bg-[#fef1cf] px-8 gap-y-16 select-none">
      {/* Reception Section */}
      <div className="bg-[#faf5e7] bg-opacity-80 rounded-lg shadow-lg p-10 flex-1 mx-4 flex flex-col justify-between">
        ...
        <div className="text-center text-gray-700 text-lg leading-relaxed max-w-md mx-auto mb-6">
          <p className="mb-4">
      ...
      <div className="bg-[#faf5e7] bg-opacity-80 rounded-lg shadow-lg p-10 flex-1 mx-4 flex flex-col justify-top gap-8">
        ...
        <div className="text-center text-gray-700 text-lg leading-relaxed max-w-2xl mx-auto">
